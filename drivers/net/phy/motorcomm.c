...
#define YT8521_EXTREG_DELAY             0xa003
#define YT8521_EXTREG_DELAY_VALUE       0x00fe
#define YT8521_EXTREG_LED0              0xa00c
#define YT8521_EXTREG_LED1              0xa00d
#define YT8521_EXTREG_LED2              0xa00e
#define YT8521_EXTREG_LED0_VALUE        0x2670
#define YT8521_EXTREG_LED1_VALUE        0x0060
#define YT8521_EXTREG_LED2_VALUE        0x2600
...
static int yt8521_config_init(struct phy_device *phydev)
{
	int ret;
	int val;
	unsigned int yt8521_led1;
	unsigned int yt8521_led2;
	...
	/* set delay */
	ret = ytphy_write_ext(phydev, YT8521_EXTREG_DELAY, YT8521_EXTREG_DELAY_VALUE);

	ret = fwnode_property_read_u32(child, "yt8521-led1", &yt8521_led1);
	if(ret)
		yt8521_led1 = YT8521_EXTREG_LED1_VALUE;

	ret = fwnode_property_read_u32(child, "yt8521-led2", &yt8521_led2);
	if(ret)
		yt8521_led2 = YT8521_EXTREG_LED2_VALUE;

	/* set led */
	//ret = ytphy_write_ext(phydev, YT8521_EXTREG_LED0, YT8521_EXTREG_LED0_VALUE);
	ret = ytphy_write_ext(phydev, YT8521_EXTREG_LED1, yt8521_led1);
	ret = ytphy_write_ext(phydev, YT8521_EXTREG_LED2, yt8521_led2);
